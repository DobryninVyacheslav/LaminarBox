...
train_and_val_data_dir = pathlib.Path("ml/src/resources/process recognition data/process_photo/train_and_val")
test_data_dir = pathlib.Path("ml/src/resources/process recognition data/process_photo/test")
